...
\noindent StateInit():
\begin{itemize}
\item transition: State Display is Initialized
\item exception: none
\end{itemize}

\noindent DisplayUserInfo(Name, SampleName, Date, Filename, SamplingRate, SampleLen, SampleWidth):
\begin{itemize}
\item transition: Display Name, SampleName Date, Filename, SamplingRate, SampleLen, and SampleWidth in user input state section  
\item exception: $exc:= SamplingRate \notin \mathbb{R} \lor SamplingRate < 0 \lor SampleLen \notin \mathbb{R} \lor SampleLen < 0 lor SampleWidth \notin \mathbb{R} \lor SampleWidth < 0 \Rightarrow INVALID$
\end{itemize}

\noindent DisplayHardwareState(Voltage, Current, Time, Temperature):
\begin{itemize}
\item transition: Display Voltage, Current, and Time in hardware state section
...
\section{MIS of File Output Module} \label{Module} 
...
\noindent WriteUserInput(Name, SampleName, Date, SamplingRate, SampleLen, SampleWidth):
\begin{itemize}
\item transition: Write user input into the first line of the file 
\item exception: $exc:= SamplingRate \notin \mathbb{R} \lor SamplingRate < 0 \lor SampleLen \notin \mathbb{R} \lor SampleLen < 0 lor SampleWidth \notin \mathbb{R} \lor SampleWidth < 0 \Rightarrow INVALID$
\end{itemize}

\noindent WriteSampleOutput(Time, Temperature, Voltage, Current, Resistance, Resistivity):
\begin{itemize}
\item transition: Write each data set into the file until the program stops
...
\hline
GraphInit() & &  &  \\
GraphTimeVResistence() & real, real &  & INVALID \\
...
\noindent GraphInit():
\begin{itemize}
\item transition: Graph is Initialize
\item exception: none
\end{itemize}

\noindent GraphTimeVResistence(Time, Resistance):
\begin{itemize}
\item transition: Disaply graph of Time versus Resistance  
\item exception: $exc:= Time \notin  \mathbb{R} \lor Time < 0 \lor  Resistance \notin  \mathbb{R} \lor Resistance < \Rightarrow INVALID$
\end{itemize}

\noindent GraphTimeVResistivity(Time, Resistivity):
\begin{itemize}
\item transition: Display graph of Time versus Resistivity
\item exception: $exc:= Time \notin  \mathbb{R} \lor Time < 0 \lor  Resistivity \notin  \mathbb{R} \lor Resistivity < \Rightarrow INVALID$
\end{itemize}

\noindent GraphVoltageVResistence(Voltage, Resistance):
\begin{itemize}
\item transition: Display graph of Voltage versus Resistance
\item exception: $exc:= Voltage\notin  \mathbb{R} \lor Voltage < 0 \lor  Resistance \notin  \mathbb{R} \lor Resistance <\Rightarrow INVALID$
\end{itemize}

\noindent GraphVoltageVResistivity(Voltage, Resistivity):
\begin{itemize}
\item transition: Display graph of Voltage versus Resistivity
\item exception: $exc:= Voltage \notin  \mathbb{R} \lor Voltage < 0 \lor  Resistivity \notin  \mathbb{R} \lor Resistivity< \Rightarrow INVALID$
\end{itemize}

\noindent GraphTemperatureVResistence(Temperature, Resistance):
\begin{itemize}
\item transition: Display graph of Temperature versus Resistance
\item exception: $exc:= Temperature \notin  \mathbb{R} \lor  Resistance \notin  \mathbb{R} \lor Resistance <\Rightarrow INVALID$
\end{itemize}

\noindent GraphTemperatureVResistivity(Temperature, Resistivity):
\begin{itemize}
\item transition: Display graph of Temperature versus Resistivity
