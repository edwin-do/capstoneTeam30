...
\midrule
Date 1 & 1.0 & Notes\\
Jan 18 2023 & 1.1 & Added MIS info for UserInputValidation, HardwareInputValidation, and Calculation Modules\\
\bottomrule
\end{tabularx}
...
\noindent verifyFileData(Filename, Date, Name):
\begin{itemize}
...
\noindent verifySampleData(SamplingRate, SampleLength, SampleWidth):
\begin{itemize}
\item output: out:= TRUE
\item exception: $exc:= 
