...
\newpage
~\newpage
\section{MIS of Input Communication Module} \label{Module} 
...
\hline
passUserInput() &  & UserInput (ADT) & \\
passHardwareInput()& & HardwareInput(ADT) & \\
\hline
\end{tabular}
\end{center}
...
The UserInput and HardwareInput are received correctly and are going to be validated by the validation modules.

\subsubsection{Access Routine Semantics}

\noindent passUserInput():
\begin{itemize}
\item output: out:= UserInput
\end{itemize}

\noindent passHardwareInput():
\begin{itemize}
...
\section{MIS of Output Communication Module} \label{Module} 
...
The values have been validated by the validation module.
...
\noindent passResistivity():
\begin{itemize}
\item output: out:= resisitivity (real)
\end{itemize}

\noindent passResistance():
\begin{itemize}
\item output: out:= resistance (real)
\end{itemize}

\subsubsection{Local Functions}
N/A

\section{MIS of Remote Access Module} \label{Module} 
...
\noindent connect():
\begin{itemize}
\item transition: Connects to the application and user can view the ApplicationWindow
\item exception: $exc:= userNameInput \ne userName \lor passwordInput \ne password \Rightarrow INVALID$
\end{itemize}

\noindent disconnect():
\begin{itemize}
\item transition: Display message informing that the user has been disconnected from the application.
\item exception: none
\end{itemize}

\noindent stop():
\begin{itemize}
\item transition: Display message that the stop was performed.
\item exception: none
\end{itemize}
