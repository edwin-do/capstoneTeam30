...
\paragraph{Input Communication Module (\mref{mInput})}
\begin{description}
...
\paragraph{Output Communication Module (\mref{mInput})}
\begin{description}
...
\paragraph{Remote Access Module (\mref{mInput})}
\begin{description}
...
\paragraph{Current State Module (\mref{mOutput})}
\begin{description}
...
\paragraph{File Output Module (\mref{mOutput})}
\begin{description}
...
\end{description}
\paragraph{Graphical Output Module (\mref{mOutput})}
\begin{description}
...
\begin{description}
  ...
  do not provide direct interaction with the user for use in data analysis.
  \item[Implemented By:] -
\end{description}

\paragraph{Resistivity Module(\mref{mCalc})}
\begin{description}
  \item[Secrets:] The mathematical equation for calculating resistivity.
  \item[Services:]Solve the equation and return the result.
  \item[Implemented By:] Calculation.cs 
  \item[Type of Module:] Abstract Data Type
\end{description}

\paragraph{Resistance Module(\mref{mCalc})}
\begin{description}
  \item[Secrets:] The mathematical equation for calculating resistance.
  \item[Services:]Solve the equation and return the result.
  \item[Implemented By:] Calculation.cs 
  \item[Type of Module:] Abstract Data Type
\end{description}
...
\paragraph{User Input Validation Module (\mref{mVal})}
\begin{description}
  \item[Secrets:] The mathematical equation for calculating resistivity.
...
\paragraph{Hardware Input Validation Module(\mref{mVal})}
\begin{description}
  \item[Secrets:] The mathematical equation for calculating resistance.
