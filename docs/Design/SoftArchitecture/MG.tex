...
\item[\refstepcounter{ucnum} \actheacnum \label{ucOS}:] Operating system (Windows 10).
\item[\refstepcounter{ucnum} \actheacnum \label{ucCalculation}:] Calculation equation formulas (Resistance equation and Resistivity equation).
\end{description}
...
\item [\refstepcounter{mnum} \mthemnum \label{mIH}:] Hardware-Hiding Module
\end{description}
...
R2 & \mref{mFO}, \mref{GO}, \mref{mC}\\
R3 & \mref{mIC}\\
R4 & \mref{mFO}, \mref{GO}, \mref{mC}\\
R5 & \mref{mRA}\\
\bottomrule
\end{tabular}
