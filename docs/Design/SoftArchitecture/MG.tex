...
\item[\refstepcounter{acnum} \actheacnum \label{ucOS}:] Operating system (Winodws 10).
\item[\refstepcounter{acnum} \actheacnum \label{ucCalculation}:] Calculation equation formulas (Resistence equation and Resistivity equation).
\end{description}
