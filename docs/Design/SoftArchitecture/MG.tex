...
\begin{description}
\item[Secrets:]The format and structure of the data from user input and hardware input.
\item[Services:]Converts the input data into the data structure used by other modules.
