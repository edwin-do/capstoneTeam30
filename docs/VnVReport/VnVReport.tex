...
Mar 8 2023 & Tyler Magarelli & Added survey results table\\
\bottomrule
\end{tabularx}
...
\hspace*{-1.5cm}
\begin{tabular}{ |p{3cm}|p{1.75cm}|p{1.75cm}|p{1.75cm}|p{1.75cm}|p{1.75cm}|p{1.75cm}| }
  \hline
  \multicolumn{7}{|c|}{User Experience Survey Results} \\
  \hline
  Survey Question & 5/Strongly Agree/Yes & 4/Agree & 3/Neither & 2/Disagree & 1/Strongly Disagree/No & \%Accepted \\
  \hline
  How easy was the system to use with no additional instruction?  & 7  & 2 & 1 & 0  & 0 & 90\%\\ \hline
  How would you rate the installation of the application in terms of simplicity?  & 8 & 1 & 0 & 1 & 0 & 90\%\\ \hline
  The graphics and wording are culturally and visually appropriate. & 10  & 0 & 0 & 0  & 0 & 100\%\\ \hline
  In your opinion does the application cause/pose any health concerns or risks. & 0  & 0 & 1 & 0 & 9 & 90\%\\ \hline
  How would you rate the graphical interface in terms of organization, usage of space, and visual appeal?  & 3  & 7 & 0 & 0  & 0 & 100\%\\ \hline
  Were you aware of how the calculations were being done when the data was being displayed?  & 1  & - & - & - & 9 & 90\%\\ \hline
