...
This document discusses the results from the test cases mentioned in the V\&V plan and the changes the team made in response. 
...
%	\begin{tabular}{|l|l|l|l|l|}
	\begin{tabular}{|p{1.3cm}|p{5cm}|p{5cm}|p{1.2cm}|}
		\hline
		\textbf{ID} & \textbf{User Action} & \textbf{Expected Result}  & \textbf{Result} \\ \hline
		FR-T1 & Type (1) in the "Current Level" textbox, type (10) in the "Compliance" textbox and click "Set All" button, select "ON" button next to "Toggle Output" label; type (100) in the "Acquisition Rate" textbox and click "Set" button & Current Source is set to 1mA and displayed, compliance voltage is set to 10V, current is turned on, nanovoltmeter acquisition rate is set to 100Hz & PASS\\ \hline
		FR-T2 & Click the "Start Capture button" and monitor graph and table output & Voltage values measured by the nanvoltmeter are displayed appropriately displayed in real-time on the GUI & PASS \\ \hline
        FR-T3 & Click the "Start Capture" button and monitor calculated resistivity values, perform  manual resistivity calculation for the sample, check the output log and compare resistivity value calculated by application to manual calculation & Resistivity values calculated by the application match manual calculations performed & PASS \\ \hline
		FR-T4 & Type (100) in the "Acquisition Rate" textbox and click "Set" button & Voltmeter display shows faster reading than default & PASS\\ \hline
        FR-T6 & Click the "Refresh" button on the remote access web client page & Main application will update its current status to the web client & PASS\\ \hline 
	\end{tabular}
\end{table}
\newpage
...
\begin{table}[H]
	\centering
	\begin{tabular}{|p{1.5cm}|p{5cm}|p{5cm}|p{1.2cm}|}
		\hline
        FR-T7 & Click the "Start Capture" button on the remote access web client page & Capture will begin on main application, web client page notifies user that capture has started & PASS\\ \hline
        FR-T8 & Click "Turn Current Supply ON/OFF" button on the remote access web client page & Current output is disabled in the system, user is notified that current output is disabled & PASS\\ \hline
        FR-T9 & Current source and nanovoltmeter settings are input as described in FR-T1, click "Start Capture" button & Measured and calculated values are displayed on the graph in real-time & PASS \\ \hline
        FR-T10 & Current source and nanovoltmeter settings are input as described in FR-T1, click "Start Capture" button and observe graph, use the mouse wheel to zoom in/out, use the scroll bar to scroll left and right, click and drag one end of the scroll bar to adjust the timespan of the graph, un-check each of the display values, re-check each of the display values & All graph features behave as expected, graph is adjustable & PASS\\ \hline
        FR-T11 & Current source and nanovoltmeter settings are input as described in FR-T1, click "Start Capture" button and allow some values to be capture, click "Stop Capture" button, check lab computer Documents folder for generated .CSV file & .CSV file was generated in the Documents folder & PASS\\ \hline
        FR-T12 & Follow steps as described in FR-T11, review generated .CSV file to ensure that it contains measured and calculated values from the application & Generated .CSV file contains correct data output from the application & PASS \\ \hline
    \end{tabular}
\end{table}
\newpage
...
\begin{table}[H]
	\centering
	\begin{tabular}{|p{1.4cm}|p{5cm}|p{5cm}|p{1.2cm}|}
		\hline
        FR-T13 & Unxip the installation package folder, check the folder for a .EXE file & The installation package folder contains a .EXE file & PASS \\ \hline
        FR-T14 & Double-click the .EXE file in the installation package folder & Application successfully launches & PASS \\ \hline
	\end{tabular}
\end{table}
...
\begin{tabular}{ |p{1.5cm}||p{2.5cm}|p{3cm}|p{2cm}|p{2cm}|p{1.5cm}|}
  ...
  Unit Test ID & Description & Input & Expected Output & Output & Result\\
  \hline
  UT-C1   & Testing the CalcResistance Method  &  5, 1 & TRUE & TRUE & PASS \\
  \hline
  UT-C1   & Testing the CalcResistance Method  &  -5, 1 & TRUE & TRUE & PASS \\
  \hline
  UT-C2   & Testing the CalcResistivity Method  &  5, 4*1, 4 & TRUE & TRUE & PASS \\
  \hline
  UT-C2   & Testing the CalcResistivity Method  &   -5, 4*1, 4 & TRUE & TRUE & PASS \\
  \hline
  UT-C3   & Testing the CalcTemperature Method  & 5, 5, 0, -10 & TRUE & TRUE & PASS \\
  \hline
  UT-C4   & Testing the CalcTemperature Method  &  5, 5, 0, 1400 & TRUE & TRUE & PASS \\
  \hline
  UT-C4   & Testing the CalcTemperature Method  &  5, 5, 0, -1400 &  TRUE & TRUE & PASS \\
  \hline
  UT-C5  & Testing the CalcAperture Method  &  1 & TRUE & TRUE & PASS \\
  \hline
  UT-C5  & Testing the CalcAperture Method  &  100 & TRUE & TRUE & PASS \\
  \hline
 \end{tabular}
 ...
 \begin{tabular}{ |p{1.5cm}||p{2.5cm}|p{3cm}|p{2cm}|p{2cm}|p{1.5cm}|}
  ...
  Unit Test ID & Description & Input & Expected Output & Output & Result\\
  \hline
  UT-C6  & Testing the CalcAperture Method  &  600 & TRUE & TRUE & PASS \\
  \hline
  UT-C6  & Testing the CalcAperture Method  &  6000 & TRUE & TRUE & PASS \\
  \hline
  UT-C7  & Testing the CalcAperture Method  &  -1 & TRUE & TRUE & PASS \\
  \hline
  UT-C7  & Testing the CalcAperture Method  &  0 & TRUE & TRUE & PASS \\
  \hline
 \end{tabular}
...
\\
 \begin{tabular}{ |p{1.5cm}||p{2cm}|p{2.5cm}|p{2cm}|p{2cm}|p{1.5cm}|}
  ...
  Unit Test ID & Description & Input & Expected Output & Output & Result\\
  \hline
  UT-UI1   & Testing the checkUserInput Method  &  N/A  & UserInput (userName: "Bob", sampleName: "Test", length: 10, width: 10, thickness: 10) &UserInput (userName: "Bob", sampleName: "Test", length: 10, width: 10, thickness: 10) & PASS \\
  \hline
  UT-UI2   & Testing the checkUserInput Method  &  UserInput (userName: null, sampleName: "Test", length: 10, width: 10, thickness: 10) & UserInput () & UserInput () & PASS \\
  \hline
  UT-UI3   & Testing the checkInputBox Method  &  10 & TRUE & TRUE & PASS \\
  \hline
  UT-UI4   & Testing the checkInputBox Method  &  null & Message informing user of invalid value & Message informing user of invalid value & PASS \\
  \hline
  UT-UI5   & Testing the validateUserData Method  &  userName: "Bob", sampleName: null, length: 10, width: 10, thickness: 10) & FALSE & FALSE & PASS \\
  \hline
 \end{tabular}
 ...
 \begin{tabular}{ |p{1.5cm}||p{2cm}|p{2.5cm}|p{2cm}|p{2cm}|p{1.5cm}|}
  ...
  Unit Test ID & Description & Input & Expected Output & Output & Result\\
  \hline
  UT-UI6   & Testing the validateUserData Method  &  userName: "Bob", sampleName: "Test", length: 10, width: 10, thickness: 10 & TRUE & TRUE & PASS \\
  \hline
  UT-UI7   & Testing the validateUserData Method  &  userName: "Bob", sampleName: "Test", length: 10, width: 10, thickness: -10 & FALSE & FALSE & PASS \\
  \hline
 \end{tabular}

 \pagebreak
 \subsection{Instrument Input Validation Module}
 ...
 \begin{tabular}{ |p{1.5cm}||p{2cm}|p{2cm}|p{3cm}|p{3cm}|p{1.5cm}|}
  ...
  Unit Test ID & Description & Input & Expected Output & Output & Result\\
  \hline
  UT-II1   & Testing the checkSampleRate Method  &  100  & TRUE & TRUE & PASS \\
  \hline
  UT-II2   & Testing the checkSampleRate Method  &  -100 & ArgumentException & ArgumentException & PASS \\
  \hline
  UT-II3   & Testing the checkCurrentLevel Method  &  100 & TRUE & TRUE & PASS \\
  \hline
  UT-II4    & Testing the checkCurrentLevel Method  &  -100 & ArgumentException & ArgumentException & PASS \\
  \hline
  UT-II5   & Testing the checkJuncTemperature Method  &  10  & TRUE & TRUE & PASS \\
  \hline
  UT-II6   & Testing the checkJuncTemperature Method  &  10000, -10000  & ArgumentException & ArgumentException & PASS \\
  \hline
 \end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{1cm}|p{5cm}|p{5cm}|p{1.3cm}|}
		...
		UT14 & System is capturing values, thermal treatment is taking place & Changes in resistivity-temperature slopes are noted in capture log and displayed & FAIL* \\ \hline
		UT15 & System is capturing values, no thermal treatment & No changes in resistivity-temperature slopes are noted in capture log or displayed & PASS \\ \hline
