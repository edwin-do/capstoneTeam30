...
begin{adjustwidth}{2.0em}{0pt}
\begin{enumerate}[{OI}1.]
  \item There are concerns about sampling rates of the development.
  \begin{enumerate}
    \item We would like to ensure that we have ideal sample rates for our project.
    \item This requires the appropriate hardware and software development to ensure the best sampling rates.
  \end {enumerate}
  \item We have concers about the drivers that will be necessary for the hardware and CPIe card that connects them to the computer.
  \begin{enumerate}
    \item We have to ensure that we have the correct drivers on the computer in order to utilize the hardware necessary for our project.
  \end {enumerate}
\end{enumerate}
\end{adjustwidth}
